SetupDrivers = function(data, isTaxi) {
    if (isTaxi == true) {
        ...
        $(".drivers-list").html('<div class="drivers-call-full"><div class="drivers-call">CALL CAB</div></div>');
        $(".drivers-call-full").fadeIn()
    }
}
...
$(document).on('click', '.driver-list-call', function(e){
    ...
    $.post('http://qb-phone/AcceptTaxiCall', JSON.stringify({
        id: id,
    }));
});
